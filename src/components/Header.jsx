    ...
    <nav className="w-full flex py-8 px-7  justify-between items-center navbar">
      ...
      <div className="sm:hidden z-10 shadow-lg flex flex-1 justify-end items-center">
        ...
        <div
          className={`${
            !toggle ? "hidden" : "flex"
          } p-6 absolute top-10 right-0 mx-4 my-2 min-w-[140px] rounded-xl sidebar`}
        >
          <ul className="list-none flex justify-end items-start flex-1 flex-col">
           ...
           <li className="font-poppins font-normal cursor-pointer text-[20px] text-white bg-[#2e0457] mb-0 mt-2 text-underline border-solid border-2 border-[#f6a135] rounded px-4 py-2">
          <a href="#register">Register</a>
        </li>
          </ul>
        </div>
